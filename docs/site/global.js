...
g.reading =
    'For your technical reading this week, you will complete the following sections of the course: ';
g.reading2 =
    g.reading.slice(0, -2) +
    '. Now that you are working on your personal project for the remainder of the semester, you will notice that not all of the readings will apply to your personal project. However, to continue your professional development and to be prepared for your quizzes and final exam, you should be familiar with these concepts.';
g.teachTime =
...
g.surveyText =
    '<p>Once you have completed your work for the week, please fill out this survey:</p>';
