...
g.project2req =
  'Your assignment for this lesson will be 100% dedicated to your team project for this portion of the semester. To review project requirements please select Project > Project 2 from the navbar. There will be a link for the requirements there. <br><img src="../projectStuff/projectRequirements.png" class="img-tutorial>';
