...
!(function (e) {
  ...
  function d(e, n, t) {
    ...
    for (; e.length || n.length; ) {
      var s = c();
      if (((a += C(t.substring(r, s[0].offset))), (r = s[0].offset), s === e)) {
        for (
          i.reverse().forEach(l);
          o(s.splice(0, 1)[0]),
            (s = c()) === e && s.length && s[0].offset === r;
        ...
        (i = f(
          (function (e, n) {
            for (
              ...
              var c = (r += 1),
                u = s(e[i]);
              for (0 < i && (a += n), a += '('; 0 < u.length; ) {
                var l = t.exec(u);
                if (null == l) {
                  a += u;
                  break;
                }
                (a += u.substring(0, l.index)),
                  (u = u.substring(l.index + l[0].length)),
                  '\\' == l[0][0] && l[1]
                    ? (a += '\\' + String(Number(l[1]) + c))
                    : ((a += l[0]), '(' == l[0] && r++);
              }
              a += ')';
            }
  ...
  function x(e, a, i, n) {
    function c(e, n) {
      ...
      if (e.eW) return c(e.parent, n);
    }
    function u(e, n, t, r) {
      if (!t && '' === n) return '';
      if (!e) return n;
      var a = '<span class="' + (r ? '' : m.classPrefix);
      return (a += e + '">') + n + (t ? '' : _);
    }
    function l() {
      (R +=
        null != g.sL
          ? (function () {
              var e = 'string' == typeof g.sL;
              if (e && !b[g.sL]) return C(v);
              var n = e
                ? x(g.sL, v, !0, d[g.sL])
                : B(v, g.sL.length ? g.sL : void 0);
              return (
                0 < g.relevance && (p += n.relevance),
                e && (d[g.sL] = n.top),
          ...
          : (function () {
              var e, n, t, r, a, i, c;
              if (!g.k) return C(v);
              for (r = '', n = 0, g.lR.lastIndex = 0, t = g.lR.exec(v); t; )
                (r += C(v.substring(n, t.index))),
                  (a = g),
                  (i = t),
                  void 0,
                  (c = E.cI ? i[0].toLowerCase() : i[0]),
                  (e = a.k.hasOwnProperty(c) && a.k[c])
                    ? ((p += e[1]), (r += u(e[0], C(t[0]))))
                    : (r += C(t[0])),
                  (n = g.lR.lastIndex),
                  (t = g.lR.exec(v));
              return r + C(v.substr(n));
            })()),
        (v = '');
    }
    function o(e) {
      (R += e.cN ? u(e.cN, '', !0) : ''),
        (g = Object.create(e, { parent: { value: g } }));
    }
    function s(e) {
      var n = e[0],
        t = e.rule;
    ...
    function t(e, n) {
      ...
      if (
        ...
        return (v += a.slice(n.index, n.index + 1)), 1;
      if ('begin' === (f = n).type) return s(n);
      if ('illegal' === n.type && !i)
        throw new Error(
          'Illegal lexeme "' + t + '" for mode "' + (g.cN || '<unnamed>') + '"'
        );
      if ('end' === n.type) {
        var r = (function (e) {
          var n = e[0],
          ...
          if (t) {
            ...
            for (
              r.skip
                ? (v += n)
                : (r.rE || r.eE || (v += n), l(), r.eE && (v = n));
              g.cN && (R += _),
                g.skip || g.sL || (p += g.relevance),
                (g = g.parent) !== t.parent;

            );
            return (
              t.starts &&
                (t.endSameAsBegin && (t.starts.eR = t.eR), o(t.starts)),
              r.rE ? 0 : n.length
            );
          }
        })(n);
    ...
    var r,
      ...
      d = {},
      R = '';
    for (r = g; r !== E; r = r.parent) r.cN && (R = u(r.cN, '', !0) + R);
    var v = '',
      p = 0;
    try {
      for (var M, N, h = 0; (g.t.lastIndex = h), (M = g.t.exec(a)); )
        (N = t(a.substring(h, M.index), M)), (h = M.index + N);
      for (t(a.substr(h)), r = g; r.parent; r = r.parent) r.cN && (R += _);
      return { relevance: p, value: R, i: !1, language: e, top: g };
    } catch (e) {
      if (e.message && -1 !== e.message.indexOf('Illegal'))
        return { i: !0, relevance: 0, value: C(a) };
      throw e;
    }
  }
  function B(t, e) {
    e = e || m.languages || i(b);
    var r = { relevance: 0, value: C(t) },
      a = r;
    return (
      e
        .filter(S)
  ...
  function S(e) {
    return (e = (e || '').toLowerCase()), b[e] || b[u[e]];
  }
  function T(e) {
    var n = S(e);
  ...
  return {
    ...
    c: [
      ...
      { b: '@(font-face|page)', l: '[a-z-]+', k: 'font-face page' },
      {
        ...
        c: [
          { cN: 'keyword', b: /\w+/ },
          { b: /\s/, eW: !0, eE: !0, relevance: 0, c: [e.ASM, e.QSM, e.CSSNM] },
        ],
      },
...
hljs.registerLanguage('javascript', function (e) {
  var r = '[A-Za-z$_][0-9A-Za-z$_]*',
    ...
    c = {
      b: 'html`',
      e: '',
      starts: { e: '`', rE: !1, c: [e.BE, n], sL: 'xml' },
    },
    s = {
      b: 'css`',
      e: '',
      starts: { e: '`', rE: !1, c: [e.BE, n], sL: 'css' },
    },
    o = { cN: 'string', b: '`', e: '`', c: [e.BE, n] };
  n.c = [e.ASM, e.QSM, c, s, o, t, e.RM];
  ...
  return {
    ...
    c: n.concat([
      ...
      { b: e.IR + '::', k: a },
      {
        ...
        k: a,
        c: n.concat([
          { b: /\(/, e: /\)/, k: a, c: n.concat(['self']), relevance: 0 },
        ]),
        relevance: 0,
      },
      {
    ...
    exports: { preprocessor: i, strings: r, k: a },
  };
});
